        ...
        <div class="row">
            <div class="col-md-8">
                <div class="me-2 ms-1">
                    ...
                    <form action="/admin/thong-ke/ton-kho/ngay" name="ngay">
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                        ...
                        <div class="mb-3 offset-6">
                            <button class="btn btn-success" type="submit" onclick="validate()">Thống kê</button>
                        </div>
                    </form>
                </div>
            </div>
            <div class="col-md-4">
                <div class="me-2 ms-1">
                    <form action="/admin/thong-ke/ton-kho/thang">
                        <div class="mb-3">
...
<%--            <div class="col-md-4">--%>
<%--                <div class="me-2 ms-1">--%>
<%--                    <form action="/admin/thong-ke-ton-kho/nam">--%>
<%--                        <div class="mb-3">--%>
